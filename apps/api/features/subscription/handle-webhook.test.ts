...
mock.module('@/packages/adapters/payments', () => ({
  payments: {
...
mock.module('@/packages/db/schema', () => ({
...
const { env: realEnv } = await import('@/packages/config/env')
mock.module('@/packages/config/env', () => ({
  env: {
    ...realEnv,
...
mock.module('@/packages/adapters/email', () => ({
