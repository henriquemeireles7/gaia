...
import { accountRoutes } from '@/apps/api/features/account/routes'
import { adminRoutes } from '@/apps/api/features/admin/routes'
import { blogRoutes } from '@/apps/api/features/blog/routes'
import { orgRoutes } from '@/apps/api/features/organizations/routes'
import { pageRoutes } from '@/apps/api/features/pages/page-routes'
import { sitemapRoutes } from '@/apps/api/features/seo/sitemap'
import { completeCheckoutRoutes } from '@/apps/api/features/subscription/complete-checkout'
import { checkoutRoutes } from '@/apps/api/features/subscription/create-checkout'
import { portalRoutes } from '@/apps/api/features/subscription/customer-portal'
import { webhookRoutes } from '@/apps/api/features/subscription/handle-webhook'
import { apiKeyAuth } from '@/packages/auth/api-key'
import { authRoutes } from '@/packages/auth/routes'
import type { AppEnv } from '@/packages/config/types'
import { csrfProtection } from '@/packages/security/csrf'
import { rateLimitMiddleware } from '@/packages/security/rate-limit'
