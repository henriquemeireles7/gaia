// scripts/check-tokens-sync.ts — fail if packages/ui/styles.css drifts
// from what scripts/generate-tokens-css.ts would produce now.
//
// Enforces the rule `tokens/single-source` in .gaia/rules.ts:
...
import { buildFormattedCSS } from './generate-tokens-css'
