// .gaia/rules/checks/check-tests-exist.ts — testing/colocated-tests
//
...
if (missing.length > 0) {
  ...
  console.error(
    '\nAdd a sibling .test.ts or extend ALLOWLIST in .gaia/rules/checks/check-tests-exist.ts with rationale.',
  )
  process.exit(1)
}
