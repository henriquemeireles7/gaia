...
Gaia is in the bootstrap phase. The repo just split from kaz-setup ("Douala") and is being rebuilt onto the v6 vision stack. The work is structural, not feature work.
