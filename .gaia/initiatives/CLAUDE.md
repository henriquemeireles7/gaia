...
| 0002 | `0002-gaia-bootstrap/`         | Clone-to-deploy in ≤30 min via agent-native CLI (`bun create gaia@latest` + verify-keys/deploy/smoke + d-fail self-heal). Template + full docs + founder-only launch gate. | code-complete — pending founder clean-machine run (see `docs/launch.md`) |
