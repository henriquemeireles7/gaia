...
- Migration off Sentry to events-as-error-stream — Sentry stays wired through `@sentry/node`. Errors *additionally* emit as `error.*` events; no Sentry removal in 0004.
