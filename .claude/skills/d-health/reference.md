...
> Status: scaffolded.
> Sibling skill: `d-health` (this folder's `SKILL.md`).
...
1. **Security** — runs `d-security` audit; rolls findings up.
...
9. **Content** — voice/tone audit (`d-content`), README freshness, doc staleness.
...
- Sibling skill: `.claude/skills/d-health/SKILL.md`
- Quarterly trigger: stale-reference detection (per `d-rules/reference.md` principle 3 — `Last verified` >180 days).
- Audit skills it dispatches: `d-security`, `d-ai`, `d-ux`, `d-dx`, `d-observability`, `d-ax`.
