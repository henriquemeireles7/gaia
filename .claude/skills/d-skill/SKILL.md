---
name: d-skill
description: 'Author or rewrite a SKILL.md file. Adversarial-review of phases, then write per skills.md conventions, then validate frontmatter. Triggers: "d-skill", "write a skill", "create new skill", "audit skill", "rewrite skill".'
---

# d-skill — Author / rewrite a SKILL.md

## Quick Reference

- `/d-skill <name>` — author a new skill at `.claude/skills/<name>/SKILL.md`
- `/d-skill rewrite <name>` — rewrite an existing skill against current `skills.md` conventions
...
6. ≥2 reference skills for shape: `.claude/skills/d-review/SKILL.md`, `.claude/skills/d-tdd/SKILL.md`
...
Show panel review in the PR body for traceability. Format identical to `d-reference`:
...
Skills that are pure procedures (d-review, d-tdd) don't add rules; they consume them.
