...
Every skill Gaia ships passes h-skill's 15-dimension audit (see `.gaia/skills/h-skill/SKILL.md`). Categories scored 1-5; anything below 3 requires fix before merge:
...
├── h-skill/              # Create + audit other skills (vendored from user)
...
```json
{
  ...
  "skills_installed": ["review", "ship", "scaffold", "harness", "h-skill"],
  "claude_md_files": [
    "CLAUDE.md",
    "apps/web/CLAUDE.md",
    "apps/api/CLAUDE.md",
...
- [ ] Skill: passes h-skill 15-category audit, score ≥3 on each
...
| 2026-04-19 | 12 AX principles adopted                                              | Grounded in h-skill 15-category framework + Anthropic skill-creator + gstack + llms.txt state of art.                                 |
...
| 2026-04-19 | h-skill 15-category framework as merge gate                           | Every skill scored 1-5 per category. <3 requires fix. Ensures consistent quality across contributed skills.                           |

---

## Cross-references

- Skill-creation skill: `.gaia/skills/h-skill/SKILL.md`
