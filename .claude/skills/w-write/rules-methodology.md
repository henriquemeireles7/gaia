...
4. **Principles** — 3-5 underlying principles that explain WHY the process works
5. **Integration** — How this connects to other methodology components
...
- Precise terminology — every concept gets a named term
...
locale: "en"
order: 1
category: "core" | "exercise" | "principle"
---
```
...
- [ ] Connects to at least one other methodology component
- [ ] No jargon without definition
- [ ] Tone is "system designer" not "self-help guru"
